...
public class ValidarContato {
	...
	private Contato contato;
        ...
        public void validarContatoInteiro() throws LetrasDobradasException, SobrenomeException{
            if(!this.validarNome()){
	...
	public boolean validarEmail(){
		...
		String[] dominio =   SplitString.split(nomes[1], ".");
		for(int i = 0; i< dominio.length; i++){
			System.out.println("n = " + dominio[i]);			
		}
		if(nomes.length > 2){
			return false;
		}
